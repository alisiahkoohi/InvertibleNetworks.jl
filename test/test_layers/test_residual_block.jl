...
# Weights
W1 = glorot_uniform(k1, k1, k1, n_in, n_hidden)
W2 = glorot_uniform(k2, k2, k2, n_hidden, n_hidden)
W3 = glorot_uniform(k1, k1, k1, 2*n_in, n_hidden)
b1 = glorot_uniform(n_hidden)
b2 = glorot_uniform(n_hidden)

W01 = glorot_uniform(k1, k1, k1, n_in, n_hidden)
W02 = glorot_uniform(k2, k2, k2, n_hidden, n_hidden)
W03 = glorot_uniform(k1, k1, k1, 2*n_in, n_hidden)
b01 = glorot_uniform(n_hidden)
b02 = glorot_uniform(n_hidden)
...
# Residual blocks
RB = ResidualBlock(W1, W2, W3, b1, b2, nx, ny, nz, batchsize)   # true weights
...
# Gradient test for weights
RB0 = ResidualBlock(W01, W02, W03, b1, b2, nx, ny, nz, batchsize)   # initial weights
f0, ΔX, ΔW1, ΔW2, ΔW3 = loss(RB0, X, Y)[1:5]
h = 0.1f0
maxiter = 5
err3 = zeros(Float32, maxiter)
...
# Gradient test for bias
RB0 = ResidualBlock(W1, W2, W3, b01, b02, nx, ny, nz, batchsize)
f0, ΔX, ΔW1, ΔW2, ΔW3, Δb1, Δb2 = loss(RB0, X, Y)
h = 0.1f0
maxiter = 5
err5 = zeros(Float32, maxiter)
